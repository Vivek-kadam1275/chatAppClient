...
const ChatInput = ({handleSendMsg}) => {
    ...
    return (
        <div className="h-[15%]   flex items-center px-8 bg-[#080420] gap-2 relative">
            ...
            <form className="w-[95%] rounded-md flex items-center gap-8 bg-[#ffffff34] px-4" onSubmit={submitHandler} >
                <input
                    type="text"
                ...
                />
                <button type="submit" className="px-8 py-1 rounded-[2rem] flex justify-center items-center bg-[#9a86f3] border-none cursor-pointer">
